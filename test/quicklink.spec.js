describe("quicklink tests", function () {
  ...
  it("should only prefetch links if allowed in origins list", async function () {
    ...
    expect(responseURLs).to.include(
  ...
  it("should only prefetch links of same origin (default)", async function () {
    ...
    expect(responseURLs).to.not.include(
      "https://github.githubassets.com/images/spinners/octocat-spinner-32.gif"
    );
  });
  ...
  it("should prefetch chunks for in-viewport links", async function () {
    ...
    expect(responseURLs).to.include(
      `${host}/test/static/css/home.6d953f22.chunk.css`
    );
    expect(responseURLs).to.include(
      `${host}/test/static/js/home.14835906.chunk.js`
    );
    expect(responseURLs).to.include(
      `${host}/test/static/media/video.b9b6e9e1.svg`
    );
    expect(responseURLs).to.include(
      `${host}/test/static/css/blog.2a8b6ab6.chunk.css`
    );
    expect(responseURLs).to.include(
      `${host}/test/static/js/blog.1dcce8a6.chunk.js`
    );
    expect(responseURLs).to.include(
      `${host}/test/static/css/about.00ec0d84.chunk.css`
    );
    expect(responseURLs).to.include(
      `${host}/test/static/js/about.921ebc84.chunk.js`
    );
